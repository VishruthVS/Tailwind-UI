      ...
      <div className="bg-white w-96 p-8 rounded-lg shadow-lg z-10">
        ...
        <div className="max-h-60 overflow-y-auto">
          <pre id={codeElementId}>
            <code>{`
${"mx-auto py-3 px-16 ml-6 text-white bg-gradient-to-r from-cyan-500 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 font-medium rounded-lg text-sm text-center mr-2 mb-2 shadow-[0_20px_50px_rgba(8,_112,_184,_0.7)]"}`}
            </code>
          </pre>
        </div>
        <button
          className="bg-blue-500 text-white px-4 py-2 rounded-md copy-button"
